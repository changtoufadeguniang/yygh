...
<div class="app-container">
    医院设置列表
      <el-form :inline="true" class="demo-form-inline">
         <el-form-item>
            <el-input  v-model="searchObjVo.hosname" placeholder="医院名称"/>
         </el-form-item>
         <el-form-item>
            <el-input v-model="searchObjVo.hoscode" placeholder="医院编号"/>
         </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList(page = 1) {
      //添加当前页参数
      this.current = page;
      console.log(this.searchObjVo);
      hospset.getPageList(this.current, this.limit, this.searchObjVo)
        .then((response) => {
          //请求成功response是接口返回数据
          //返回集合赋值list
